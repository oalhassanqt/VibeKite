 ...
 * This file demonstrates how to integrate Vibekite with a web frontend
 */

// For React/Vue/Angular applications
export class VibekiteClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VibekiteClient(provider, contractAddress);
